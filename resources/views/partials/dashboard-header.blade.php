    ...
    <div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
        <nav>
            <ul class="lg:flex items-center justify-between text-sm font-medium text-gray-700 pt-4 lg:pt-0">
                ...
                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent @if(Request::is('courses')) {{ 'border-pink-500 text-pink-500 font-bold' }} @else {{ 'text-gray-600 hover:text-gray-900' }} @endif" href="#">Courses</a></li>
                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent @if(Request::is('users')) {{ 'border-pink-500 text-pink-500 font-bold' }} @else {{ 'text-gray-600 hover:text-gray-900' }} @endif" href="#">Users</a></li>
                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent @if(Request::is('support')) {{ 'border-pink-500 text-pink-500 font-bold' }} @else {{ 'text-gray-600 hover:text-gray-900' }} @endif" href="{{ route('support') }}">Support</a></li>
            </ul>
        </nav>
