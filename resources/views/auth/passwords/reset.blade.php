                ...
                <div class="flex-1 p-6 sm:p-10 sm:py-12">
                    ...
                    <div class="flex flex-wrap items-center">
                        <div class="w-full sm:flex-1">
                            <input type="submit" value="Reset Password" class="w-full sm:w-auto bg-indigo-500 text-indigo-100 px-6 py-2 rounded-full hover:bg-indigo-600 focus:outline-none cursor-pointer">
                        </div>
                    </div>
                </div>
            </div>
